            ...
            <div class="col-12 col-xl-11">
              ...
              <div class="d-flex mb-5">
                ...
                <div>
                  ...
                  <address class="mb-0 text-secondary">{{$appSetting->address}}</address>
                </div>
              </div>
              <div class="row mb-5">
                <div class="col-12 col-sm-6">
                  <div class="d-flex mb-5 mb-sm-0">
                    ...
                    <div>
                      ...
                      <p class="mb-0">
                        <a class="link-secondary text-decoration-none" href="tel:+15057922430">{{$appSetting->phone_1}}</a>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-6">
                  <div class="d-flex mb-0">
                    ...
                    <div>
                      ...
                      <p class="mb-0">
                        <a class="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">{{$appSetting->website_name}}@gmail.com</a>
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="bg-white border rounded shadow-sm overflow-hidden">
            ...
            <form action="{{ url('/contact-us') }}" method="POST">
              ...
              <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                ...
                <div class="col-12">
                  <div class="d-grid">
                    <button class="btn btn-primary btn-lg" type="submit" onclick="alert('Thank You For Contact-Us')">Send Message</button>
                  </div>
                </div>
              </div>
            </form>
